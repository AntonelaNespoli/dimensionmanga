    ...
    <div class="col-md-6 col-md-offset-3">
      ...
      <form action="guardarManga" method="post">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="nombre" name="nombre"  value="{$nombre}" placeholder="Nombre del Manga">
        </div>
        <div class="form-group">
            <label for="nombre">Autor Manga:</label>
            <input type="text" class="form-control" id="autor" name="autor"  value="{$autor}" placeholder="Autor del Manga">
          </div>
          <div class="form-group">
